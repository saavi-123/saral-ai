...
async function getThreads(documentId) {
  const res = await fetch(
    `${process.env.STRAPI_URL}/api/chat-threads?filters[project][documentId][$eq]=${documentId}&sort=createdAt:desc`,
    {
      headers: { Authorization: `Bearer ${process.env.STRAPI_ADMIN_TOKEN}` },
      cache: "no-store",
    }
    ...
    <div>
      ...
      {threads.length === 0 ? (
        ...
        >
          ...
          <div
            style={{ fontSize: "13px", color: "var(--text2)", marginBottom: "20px" }}
          >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "12px", color: "var(--text3)", marginTop: "2px" }}>
                ...
                {isBranch && (
                  <span style={{ color: "#534AB7", marginLeft: "6px" }}>· branched</span>
                )}
              </div>
            </div>
          </div>
